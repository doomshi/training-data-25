...
public class BasicDataOperationUsingMap {
    ...
    /**
     * Внутрішній клас Tortoise для зберігання інформації про домашню тварину
     * (сухопутна черепаха).
     * 
     * Характеристики:
     * - nickname (кличка)
    ...
    public static class Tortoise implements Comparable<Tortoise> {
         ...
         * 
         *         Критерій порівняння: nickname (за зростанням), потім shellThickness
         *         (за зростанням).
         * 
        ...
        public int compareTo(Tortoise other) {
            ...
            if (this.shellThickness == null && other.shellThickness == null)
                return 0;
            if (this.shellThickness == null)
                return -1;
            if (other.shellThickness == null)
                return 1;
         ...
         * 
         *         Важливо: метод узгоджений з compareTo() - якщо equals() повертає
         *         true,
         *         то compareTo() повертає 0, оскільки обидва методи порівнюють за
         *         nickname та shellThickness.
         */
        @Override
        public boolean equals(Object obj) {
            ...
            boolean shellEquals = shellThickness != null ? shellThickness.equals(tortoise.shellThickness)
                    : tortoise.shellThickness == null;
         ...
         * 
         *         Базується на полях nickname та shellThickness для узгодженості з
         *         equals().
         * 
        ...
        public int hashCode() {
            ...
            // Додаємо хеш-код товщини панциря (або 0, якщо shellThickness == null) до
